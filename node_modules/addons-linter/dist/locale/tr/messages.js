module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Invalid nesting of selectors found":[ "Seçicilerin geçersiz gruplanması tespit edildi" ],
      "Selectors should not be nested":[ "Seçiciler iç içe olmamalı" ],
      "A CSS syntax error was encountered":[ "Bir CSS söz dizimi hatasıyla karşılaşıldı" ],
      "An error was found in the CSS file being processed. As a result, further processing of that file is not possible":[ "İşlenmekte olan CSS dosyasında bir hata bulundu. Bu nedenle bu dosyanın daha fazla işlenmesi mümkün değildir" ],
      ...
      "\"{{api}}\" has been removed in Manifest Version 3 (`manifest_version` property)":[ "\"{{api}}\" Manifest Version 3'te kaldırılmıştır (`manifest_version` özelliği)" ],
      ...
      "String name should only contain alpha-numeric characters, _ and @ (https://mzl.la/2Eztyi5).":[ "Dizgi adı sadece alfanümerik karakterleri; _ ve @ karakterlerini içermelidir (https://mzl.la/2Eztyi5)." ],
